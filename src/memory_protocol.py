...
class MemoryAPI(Protocol):
    ...
    async def flag_contradiction(self, stmt_id_1: str, stmt_id_2: str, reason: str = "") -> None: ...
    ...
    async def update_schema(self, changes: dict[str, Any], source: str) -> dict[str, Any]: ...
